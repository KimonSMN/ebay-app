  ...
  return (
    <div className="flex justify-center h-screen">
      <div className="w-1/3 m-10 border-gray-300 border-1 rounded-sm">
        ...
        <h2 className="text-sm ml-4 mb-2 mt-2 text-gray-500">
          Fill out the details below to create your listing. Make sure to
        ...
        <div className="m-4 shadow-lg border-1 border-gray-300 max-w rounded-sm bg-white">
          ...
          <EntryField
            title={"Description"}
            placeholder={
              "Describe your item in detail. Include any defects, features, or important information buyers should know."
            }
            large={true}
          />
